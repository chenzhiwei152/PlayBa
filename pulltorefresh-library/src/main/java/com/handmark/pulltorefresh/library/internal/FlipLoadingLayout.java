...
public class FlipLoadingLayout extends LoadingLayout {
	...
	public FlipLoadingLayout(Context context, final Mode mode,
		...
		if(animationDrawable==null){
			mHeaderProgress.setImageResource(R.drawable.animation);
			animationDrawable = (AnimationDrawable) mHeaderProgress.getDrawable();
		}
	}
...
//		}
	...
	protected void onPullImpl(float scaleOfLayout) {
		// NO-OP
		//传进来的 数
		Log.e("djx", "onPullImpl:"+ scaleOfLayout);
		if(scaleOfLayout>1) {
			scaleOfLayout = 1;
		}
...
////		Bitmap  bitmap = BitmapFactory.decodeResource(this.getContext().getResources(), R.drawable.b);
////		Bitmap newIcon = Bitmap.createBitmap(bitmap, 0, 0, 10, 10, matrix, true);
//////		bianxing.setImageBitmap(newIcon);
////		mHeaderProgress.setImageBitmap(newIcon);
