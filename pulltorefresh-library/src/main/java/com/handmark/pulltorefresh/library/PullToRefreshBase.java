...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
    ...
    public interface HeaderFooterScrollListener{
        void headerScrolle(View header,int value);
        void footerScrolle(View footer,int value);
    }

    private HeaderFooterScrollListener hfScrollListener;

    public void setHeaderFooterScrollListener(HeaderFooterScrollListener hfScrollListener){
        this.hfScrollListener = hfScrollListener;
    }
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (mLayoutVisibilityChangesEnabled) {
            if (value < 0) {
                if (hfScrollListener != null){
                    hfScrollListener.headerScrolle(mHeaderLayout, value);
                }
                mHeaderLayout.setVisibility(View.VISIBLE);
            } else if (value > 0) {
                if (hfScrollListener != null){
                    hfScrollListener.footerScrolle(mFooterLayout,value);
                }
