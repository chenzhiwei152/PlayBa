...
public abstract class LoadingLayout extends FrameLayout implements
	...
	protected final ImageView bianxing;
...
//			break;
		...
		default:
			LayoutInflater.from(context).inflate(
					R.layout.pull_to_refresh_header_vertical_rb, this);
			break;
		}
		...
		bianxing = (ImageView) mInnerLayout
				.findViewById(R.id.bianxing);
	...
	public final void hideAllViews() {
		Log.e("djx","hideAllViews");
		if (View.VISIBLE == bianxing.getVisibility()){
			Log.e("djx","hideAllViews1");
		}else{
			Log.e("djx","hideAllViews2");
...
//		mHeaderImage.setVisibility(View.VISIBLE);
		...
		if (mUseIntrinsicAnimation) {
			...
			((AnimationDrawable) mHeaderProgress.getDrawable()).stop();
		} else {
			// Now call the callback
			resetImpl();
		}
...
//		mHeaderImage.setImageDrawable(imageDrawable);
	...
	public final void showInvisibleViews() {
		Log.e("djx","showInvisibleViews");

		if (View.INVISIBLE == bianxing.getVisibility()){
			Log.e("djx","showInvisibleViews1");
		}else{
			Log.e("djx","showInvisibleViews2");
